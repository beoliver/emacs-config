...
#+PROPERTY: header-args :tangle generated-init.el :padline yes :comments link

The =#+PROPERTY= header allows us to *tangle* this file and produce an emacs lisp file =generated-init.el=.
